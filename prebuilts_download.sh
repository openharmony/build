...
if [[ "${host_platform}" == "linux" ]]; then
    copy_config+="""
        ...
        prebuilts/previewer/windows,${tool_repo}/harmonyos/develop_tools/previewer/3.1.11.2/previewer-3.1.11.2-3.1release-20221219.win.tar.gz
        prebuilts/clang/ohos/windows-x86_64,${tool_repo}/harmonyos/compiler/clang/10.0.1-480513/windows/clang-480513-windows-x86_64-20221021.tar.bz2
	...
	prebuilts/clang/ohos/${host_platform}-x86_64,${tool_repo}/harmonyos/compiler/clang/10.0.1-480513/${host_platform}/clang-480513-${host_platform}-x86_64-20220815.tar.bz2
        """
elif [[ "${host_platform}" == "darwin" ]]; then
    copy_config+="""
        prebuilts/previewer/darwin,${tool_repo}/harmonyos/develop_tools/previewer/3.1.11.2/previewer-3.1.11.2-3.1release-20221219.mac.tar.gz
        prebuilts/clang/ohos/${host_platform}-x86_64,${tool_repo}/harmonyos/compiler/clang/10.0.1-480513/${host_platform}/libcxx-ndk-480513-${host_platform}-x86_64.tar.bz2
	prebuilts/python,${tool_repo}/harmonyos/compiler/python/3.9.2/${host_platform}/python-${host_platform}-x86-3.9.2_202205071615.tar.gz
        prebuilts/clang/ohos/${host_platform}-x86_64,${tool_repo}/harmonyos/compiler/clang/10.0.1-480513/${host_platform}/clang-480513-${host_platform}-x86_64-20221021.tar.bz2
	"""
fi
...
do
    ...
    if [ -d "${code_dir}/prebuilts/clang/ohos/windows-x86_64/clang-480513-20221021" ];then
        rm -rf "${code_dir}/prebuilts/clang/ohos/windows-x86_64/llvm"
        mv "${code_dir}/prebuilts/clang/ohos/windows-x86_64/clang-480513-20221021" "${code_dir}/prebuilts/clang/ohos/windows-x86_64/llvm"
    ln -snf 10.0.1 "${code_dir}/prebuilts/clang/ohos/windows-x86_64/llvm/lib/clang/current"
    fi
    if [ -d "${code_dir}/prebuilts/clang/ohos/linux-x86_64/clang-480513-20220815" ];then
        rm -rf "${code_dir}/prebuilts/clang/ohos/linux-x86_64/llvm"
        mv "${code_dir}/prebuilts/clang/ohos/linux-x86_64/clang-480513-20220815" "${code_dir}/prebuilts/clang/ohos/linux-x86_64/llvm"
	ln -snf 10.0.1 "${code_dir}/prebuilts/clang/ohos/linux-x86_64/llvm/lib/clang/current"
    fi
    if [ -d "${code_dir}/prebuilts/clang/ohos/darwin-x86_64/clang-480513-20221021" ];then
        rm -rf "${code_dir}/prebuilts/clang/ohos/darwin-x86_64/llvm"
        mv "${code_dir}/prebuilts/clang/ohos/darwin-x86_64/clang-480513-20221021" "${code_dir}/prebuilts/clang/ohos/darwin-x86_64/llvm"
