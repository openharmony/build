...
do
    ...
    if [ -d "${code_dir}/prebuilts/clang/ohos/linux-x86_64/clang-480513-20221021" ];then
        rm -rf "${code_dir}/prebuilts/clang/ohos/linux-x86_64/llvm"
        mv "${code_dir}/prebuilts/clang/ohos/linux-x86_64/clang-480513-20221021" "${code_dir}/prebuilts/clang/ohos/linux-x86_64/llvm"
