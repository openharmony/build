...
if [[ "${host_platform}" == "linux" ]]; then
    copy_config+="""
        ...
        prebuilts/previewer/windows,${tool_repo}/harmonyos/develop_tools/previewer/3.1.11.2/previewer-3.1.11.2-3.1release-20221222.win.tar.gz
    ...
    copy_config+="""
        prebuilts/previewer/darwin,${tool_repo}/harmonyos/develop_tools/previewer/3.1.11.2/previewer-3.1.11.2-3.1release-20221222.mac.tar.gz
        prebuilts/clang/ohos/${host_platform}-x86_64,${tool_repo}/harmonyos/compiler/clang/10.0.1-480513/${host_platform}/libcxx-ndk-480513-${host_platform}-x86_64.tar.bz2
