...
llvm_dir_linux_arm64="${code_dir}/prebuilts/clang/ohos/linux-aarch64"
llvm_dir_list=($llvm_dir $llvm_dir_win $llvm_dir_mac_x86 $llvm_dir_mac_arm64 $llvm_dir_ohos_arm64 $llvm_dir_linux_arm64)
