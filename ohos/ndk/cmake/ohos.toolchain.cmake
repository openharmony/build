...
if(NOT DEFINED _OHOS_USER_SHARED_LINKER_FLAGS)
  set(_OHOS_USER_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS}" CACHE INTERNAL "")
endif()
set(CMAKE_SHARED_LINKER_FLAGS "${OHOS_COMMON_LINKER_FLAGS} ${_DEVICEINFO_LIB} ${_OHOS_USER_SHARED_LINKER_FLAGS}" CACHE STRING "Linker flags to be used to create shared libraries." FORCE)

if(NOT DEFINED _OHOS_USER_MODULE_LINKER_FLAGS)
  set(_OHOS_USER_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS}" CACHE INTERNAL "")
endif()
set(CMAKE_MODULE_LINKER_FLAGS "${OHOS_COMMON_LINKER_FLAGS} ${_DEVICEINFO_LIB} ${_OHOS_USER_MODULE_LINKER_FLAGS}" CACHE STRING "Linker flags to be used to create modules." FORCE)

if(NOT DEFINED _OHOS_USER_EXE_LINKER_FLAGS)
  set(_OHOS_USER_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS}" CACHE INTERNAL "")
endif()
set(CMAKE_EXE_LINKER_FLAGS "${OHOS_COMMON_LINKER_FLAGS} ${OHOS_EXE_LINKER_FLAGS} ${_DEVICEINFO_LIB} ${_OHOS_USER_EXE_LINKER_FLAGS}" CACHE STRING "Linker flags to be used to create executables." FORCE)
