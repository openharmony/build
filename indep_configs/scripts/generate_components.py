...
def main():
    ...
    output_part_path = os.path.join(project_path, 'out', variants, production_dir, 'build_configs', 'parts_info')
    output_config_path = os.path.join(project_path, 'out', variants, production_dir, 'build_configs')
    ...
    _link_kernel_binarys(variants + os.sep + production_dir, hpm_cache_path, dependences_json, _get_target_cpu(root_path, variants))
    _copy_test_binarys(test_check, variants + os.sep + production_dir, hpm_cache_path, dependences_json)
